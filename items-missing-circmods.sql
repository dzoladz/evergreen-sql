...
SELECT ou.name AS "Library", 
	...
	c.circ_modifier AS "Circulation Modifier", 
	c.barcode AS "Barcode", 
	xpath('//m:datafield[@tag="245"]/m:subfield[@code="a"]/text()', b.marc::xml, ARRAY[ARRAY['m','http://www.loc.gov/MARC21/slim']]) as "Title", 'Missing circ mod' as "Issue"
